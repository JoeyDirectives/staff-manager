<template>
  <div>
    ...
    <!-- 申请dialog -->
    <v-dialog v-model="showBusinessTripDialog" width="650px" persistent>
      <v-card>
        ...
        <v-container>
          ...
          <div class="div-display">
            <span class="span-style">出差目的地</span>
            <v-text-field
              dense
              class="select-style"
              ...
              label="目的地"
              v-model="leaveInfo.place"
              outlined
            ></v-text-field>
            <br />
            <div style="height: 16px"></div>
            <span class="span-style">出差时间段</span>
            <v-text-field
              dense
              class="select-style"
              style="margin-left: 25px;"
            ...
            <div style="height: 16px"></div>
            <div>
              <span class="span-style">出差事由</span>
              <v-textarea
                outlined
                label="出差事由"
