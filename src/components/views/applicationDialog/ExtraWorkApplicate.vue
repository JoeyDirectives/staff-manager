<template>
  <div>
    ...
    <!-- 申请dialog -->
    <v-dialog v-model="showExtraWorkDialog" width="650px" persistent>
      <v-card>
        ...
        <v-container>
          ...
          <div class="div-display">
            ...
            <span class="span-style">加班时间段</span>
            <v-text-field
              dense
              class="select-style"
            ...
            <div style="height: 16px"></div>
            <div>
              <span class="span-style">加班事由</span>
              <v-textarea
                outlined
                label="加班事由"
...
export default {
  ...
  methods: {
    ...
    toApplication() {
      ...
      let info = {
        applicateNum: `EW-${new Date().toISOString().substr(0, 10)}-${++this
          .counter}`,
        applicateName: "加班申请",
